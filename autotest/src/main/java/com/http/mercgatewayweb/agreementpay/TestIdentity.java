 ...
 * @Description: 实名信息查询(200020)
 */
public class TestIdentity extends RequestMsgUtils {

    private static Logger LOGGER = LoggerFactory.getLogger(TestIdentity.class);
    ...
    @Test(description = "实名信息查询(200020)")
