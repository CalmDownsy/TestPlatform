...
public class TestAgreementpayGetsignurl extends RequestMsgUtils{
    ...
    public void getSignURLInit(){
		...
		riskMsg.put("receiveUserName", "小熊猫1");
    ...
    public void testGetsignurl() throws Exception {
    	logger.info("###  开始执行 获取签约URL(200013)（merc-front-web/agreementpay/getsignurl） 用例...");
    	getSignURLInit();
        ...
        logger.info("###  开始执行 签约发送短信（merc-front-web/agreementpay/signsms） 用例...");
    	/*签约发送短信请求参数*/
        ...
        logger.info("###  开始执行 绑卡签约（merc-front-web/agreementpay/bindcardsign） 用例...");
        /*绑卡签约请求参数*/
