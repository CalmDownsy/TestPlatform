...
public class TestOpenAccountUserAccountAndCancel extends RequestMsgUtils{
    ...
    private String reqCancelSmsUrl = randomUtils.getProperties("url.properties").getProperty("merc-front-web")+ "/accountcancel/cancelsms";
    private String reqCancelUrl = randomUtils.getProperties("url.properties").getProperty("merc-front-web")+"/accountcancel/cancel";
