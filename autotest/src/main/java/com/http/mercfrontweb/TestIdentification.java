...
public class TestIdentification extends RequestMsgUtils {
    ...
    public void identification() throws Exception {
        ...
        LOGGER.info("---------------------<实名认证>-----------------------");
        String identificationUrl = randomUtils.getProperties("url.properties").getProperty("merc-front-web") + "agreementpay/identification";
        ...
        String queryUserInfoUrl = randomUtils.getProperties("url.properties").getProperty("merc-front-web") + "agreementpay/queryuserinfo";
        transMap.clear();
        ...
        String checkUserInfoUrl = randomUtils.getProperties("url.properties").getProperty("merc-front-web") + "agreementpay/checkuserinfo";
        transMap.clear();
