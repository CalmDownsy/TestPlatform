...
{
    private String prefix = "test/interface";

    @Autowired
    private ITestInterfaceInfoService testInterfaceInfoService;

    @RequiresPermissions("test:interface:view")
    @GetMapping()
     ...
     * 查询接口信息实体列表
     */
    @RequiresPermissions("test:interface:list")
    @PostMapping("/list")
    @ResponseBody
     ...
     * 导出接口信息实体列表
     */
    @RequiresPermissions("test:interface:export")
    @PostMapping("/export")
    @ResponseBody
     ...
     * 新增保存接口信息实体
     */
    @RequiresPermissions("test:interface:add")
     ...
     * 修改保存接口信息实体
     */
    @RequiresPermissions("test:interface:edit")
     ...
     * 删除接口信息实体
     */
    @RequiresPermissions("test:interface:remove")
