...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('RuoyiScheduler', 'LAPTOP-1KE25J321569044629124', '1569045428416', '15000');
...
-- ----------------------------
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME1', 'DEFAULT', 'TASK_CLASS_NAME1', 'DEFAULT', null, '1569044630000', '-1', '5', 'PAUSED', 'CRON', '1569044629000', '0', null, '2', '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME2', 'DEFAULT', 'TASK_CLASS_NAME2', 'DEFAULT', null, '1569044640000', '-1', '5', 'PAUSED', 'CRON', '1569044629000', '0', null, '2', '');
INSERT INTO `qrtz_triggers` VALUES ('RuoyiScheduler', 'TASK_CLASS_NAME3', 'DEFAULT', 'TASK_CLASS_NAME3', 'DEFAULT', null, '1569044640000', '-1', '5', 'PAUSED', 'CRON', '1569044629000', '0', null, '2', '');
...
INSERT INTO `sys_menu` VALUES ('2002', '用例管理', '2000', '1', '/test/testcase', 'menuItem', 'C', '0', 'test:testcase:view', '#', 'admin', '2019-07-27 14:46:39', '', null, '');
...
-- ----------------------------
INSERT INTO `sys_oper_log` VALUES ('100', '工单管理', '2', 'com.ruoyi.web.controller.testplatform.WorkOrderController.editSave()', 'POST', '1', 'admin', '研发部门', '/test/workorder/edit', '127.0.0.1', '内网IP', '{\r\n  \"workOrderId\" : [ \"13\" ],\r\n  \"workOrderNum\" : [ \"CF2018081111\" ],\r\n  \"workOrderName\" : [ \"测试工单创建\" ],\r\n  \"workOrderType\" : [ \"4\" ],\r\n  \"status\" : [ \"0\" ],\r\n  \"startTime\" : [ \"2019-08-09\" ],\r\n  \"endTime\" : [ \"2019-08-24\" ],\r\n  \"remark\" : [ \"备注\" ]\r\n}', '{\r\n  \"msg\" : \"操作成功\",\r\n  \"code\" : 0\r\n}', '0', null, '2019-09-21 12:56:07');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '103', 'admin', '若依', '00', 'ry@163.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2019-09-21 12:40:46', 'admin', '2018-03-16 11:33:00', 'ry', '2019-09-21 12:40:46', '管理员');
...
-- ----------------------------
INSERT INTO `sys_user_online` VALUES ('0a6f9d0f-3d1b-4f6c-9c16-1af76b1f7621', 'admin', '研发部门', '127.0.0.1', '内网IP', 'Firefox', 'Windows 10', 'on_line', '2019-09-21 13:44:15', '2019-09-21 13:53:12', '1800000');
